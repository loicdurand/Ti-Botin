 ...
 */
final class Version20251110123556 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE `user` (id INT AUTO_INCREMENT NOT NULL, unite_id INT NOT NULL, fonction VARCHAR(1) DEFAULT NULL, grade VARCHAR(10) DEFAULT NULL, nom VARCHAR(50) NOT NULL, prenom VARCHAR(50) NOT NULL, specificite VARCHAR(8) NOT NULL, tph VARCHAR(18) DEFAULT NULL, port VARCHAR(18) DEFAULT NULL, tph_interne VARCHAR(5) DEFAULT NULL, mail VARCHAR(100) DEFAULT NULL, qualification VARCHAR(4) DEFAULT NULL, position_administrative VARCHAR(4) DEFAULT NULL, account_status VARCHAR(10) DEFAULT NULL, civilite VARCHAR(3) DEFAULT NULL, employee_type VARCHAR(14) DEFAULT NULL, grade_long VARCHAR(50) DEFAULT NULL, statut_corps VARCHAR(9) DEFAULT NULL, nigend INT DEFAULT NULL, INDEX IDX_8D93D649EC4A74AB (unite_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
